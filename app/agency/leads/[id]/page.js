...
export default function LeadDetailPage() {
  ...
  const handleAssignAgent = async () => {
    ...
    try {
      await api.put(`/leads/${params.id}/assign`, { assignedAgent: selectedAgentId })
          ...
          <div className="space-y-6">
            ...
            {editing ? (
              ...
              <>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {lead.assignedAgent && (
                          <button
                            onClick={() => setSelectedAgentId(lead.assignedAgent._id || lead.assignedAgent)}
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <h2 className="text-lg font-semibold text-gray-900 mb-4">Assign to Agent</h2>
                  <div className="space-y-3">
                    <select
                      value={selectedAgentId || (lead.assignedAgent?._id || lead.assignedAgent || '')}
                    ...
                    >
                      {assigningAgent ? 'Assigning...' : lead.assignedAgent ? 'Reassign Agent' : 'Assign Agent'}
                    </button>
                  </div>
                </div>
              </>
