                    ...
                    {lead.reminders.map((reminder) => {
                      ...
                      return (
                        <tr key={reminder._id} className={reminder.isCompleted ? 'bg-gray-50' : isOverdue ? 'bg-red-50' : 'hover:bg-gray-50'}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${reminder.isCompleted
                    ...
                    <div className="border border-gray-200 rounded-lg p-4">
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        <div className="flex-1 bg-gray-200 rounded-full h-4">
                          <div
                            className={`h-4 rounded-full transition-all ${lead.score >= 70 ? 'bg-red-500' :
                        ...
                        <tbody className="divide-y divide-gray-100">
                          <tr>
                            ...
                            <td className="py-2 text-right">
                              <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${lead.sla.firstContactStatus === 'breached' ? 'bg-red-100 text-red-800' :
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-4 text-sm">
                        <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${lead.siteVisit.status === 'completed' ? 'bg-green-100 text-green-800' :
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    {lead.booking.agreementStatus && (
                      <tr>
                        ...
                        <td className="py-3 px-4 text-sm">
                          <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${lead.booking.agreementStatus === 'signed' ? 'bg-green-100 text-green-800' :
                    ...
                    {lead.tasks.map((task) => {
                      ...
                      return (
                        <tr key={task._id} className={task.status === 'completed' ? 'bg-gray-50' : isOverdue ? 'bg-red-50' : 'hover:bg-gray-50'}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${task.taskType === 'call_back' ? 'bg-blue-100 text-blue-800' :
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${task.priority === 'urgent' ? 'bg-red-100 text-red-800' :
